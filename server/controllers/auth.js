...
const createToken = (username, id) => {
  return jwt.sign({ username, id }, JWT_SECRET_KEY, { expiresIn: 60000 }); // Sign key with payload (username & id), JWT Secret and expiration of 24 hrs 86400000.
};
  ...
  register: async (req, res) => {
    try {
      ...
      if (foundUser) {
        ...
        const exp = Date.now() + 60000; // Sets expiration to 24 hrs
